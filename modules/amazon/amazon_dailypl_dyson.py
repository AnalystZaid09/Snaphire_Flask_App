...
st.set_page_config(page_title="Daily-P&L with Dyson Support", page_icon="📊", layout="wide")
apply_professional_style()

render_header("Daily-P&L with Dyson Support", "Upload your Amazon transaction CSV and Product Master (PM) Excel file to analyze profits.")
st.markdown(
